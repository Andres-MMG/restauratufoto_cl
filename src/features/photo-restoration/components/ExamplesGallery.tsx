...
export function ExamplesGallery({ examples }: ExamplesGalleryProps) {
  const defaultExamples: Example[] = [
    {
      beforeImage:
        'https://images.pexels.com/photos/2447042/pexels-photo-2447042.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      afterImage:
    ...
    {
      beforeImage:
        'https://images.pexels.com/photos/5967029/pexels-photo-5967029.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      afterImage:
